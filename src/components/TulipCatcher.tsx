    ...
    <section className={styles.gameSection}>
      <div className={styles.container}>
        <div className={styles.gameHeader}>
          <h2>Senin İçin Bir Oyun 🌷</h2>
          <p>Gizli ödül için düşen {TARGET_SCORE} laleyi yakala!</p>
        </div>
          ...
          <div className={styles.startScreen}>
            <div className={styles.startCard}>
              ...
              <ul className={styles.instructions}>
                <li>🌷 Yakalamak için düşen lalere tıkla</li>
                <li>🎯 Kazanmak için {TARGET_SCORE} lale yakala</li>
                <li>⏱️ Lalelerin ekrandan düşmelerine izin verme!</li>
              </ul>
