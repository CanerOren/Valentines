...
export default function InviteCard({ onPlayAgain }: InviteCardProps) {
  const handleYesClick = () => {
    ...
    alert('🎉 Seninle bir ömür geçirmek için sabırsızlanıyorum! 💕');
  };
      ...
      <div className={styles.inviteCard}>
        ...
        <div className={styles.inviteDetails}>
          <div className={styles.detailItem}>
            ...
            <div>
              <div className={styles.detailLabel}>Tarih</div>
          ...
          <div className={styles.detailItem}>
            <span className={styles.detailIcon}>🕐</span>
            <div>
              <div className={styles.detailLabel}>Zaman</div>
          ...
          <div className={styles.detailItem}>
            <span className={styles.detailIcon}>📍</span>
            <div>
              <div className={styles.detailLabel}>Yer</div>
